...
namespace Centric_Project_rc744716.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "profileID,firstName,lastName,office,position")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "profileID,firstName,lastName,office,position")] Profile profile)
        {
            if (ModelState.IsValid)
            {
